...
//    public List<ProductosMockDAO> obtenerProductosMock() {
...
//    public List<ProductosMockDAO> obtenerProductosPorTipo(TipoProducto tipo) {
//        List<ProductosMockDAO> todos = obtenerProductosMock();
//        List<ProductosMockDAO> filtrados = new ArrayList<>();
//        
//        for (ProductosMockDAO producto : todos) {
...
//    }
    ...
    public void mostrarPantallaVistaProducto(JFrame pantallaActual, ProductosMockDAO productoSeleccionado, JFrame pantallaPadre) {
